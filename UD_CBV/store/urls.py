...
from .views import (BookCreateView, BookDeleteView, BookDetailView, BookFormView, BookRedirectView, BookUpdateView, IndexView, HomeView, BookListView, delete_picture)
